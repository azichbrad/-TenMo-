    ...
    public class UserSqlDAO : IUserDAO
    {
        ...
        public decimal GetBalance(User user)
        {
            ...
            try
            {
                ...
                {
                    conn.Open();
                    SqlCommand cmd = new SqlCommand("select balance from accounts join users on accounts.user_id = users.user_id where username = @username", conn);
                    //SqlCommand sqlCommand = new SqlCommand(cmd, conn);
                    cmd.Parameters.AddWithValue("@username", user.Username);
                    //SqlDataReader reader = cmd.ExecuteReader();
                    decimal accountBalance = Convert.ToDecimal(cmd.ExecuteScalar());
